...
public class OngoingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ongoing_trip, container, false);
    ...
    public void loadTripApi()
    {
        ...
        Call<UpcomingTripResponse> call = apiInterface.getTripDetails(PrefUtils.getFromPrefs(getContext(),PrefUtils.user_email,""),"running");
    ...
    public void initViews()
    {
        ...
        if(upTrips.size()==0)
        {
            ...
            msg.setText("No On Going Trips to Show");

        }
        else
        {
            RecyclerView.Adapter adapter = new TripAdapter(getContext(),upTrips,2);
